...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/databrary/sqlboiler", "gopkg.in/nullbio/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/databrary/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/databrary/sqlboiler" && c.thirdParty[1] != "gopkg.in/nullbio/null.v6" {
		t.Errorf("Wanted: github.com/databrary/sqlboiler, gopkg.in/nullbio/null.v6 got: %#v", c.thirdParty)
	}
}
