...
var noEditDisclaimer = []byte(`// This file is generated by SQLBoiler (https://github.com/databrary/sqlboiler)
...
func executeTemplates(e executeTemplateData) error {
	...
	for _, tplName := range e.templates.Templates() {
		if len(e.helperTemplates) > 0 {
			if err := executeTemplateWithHelpers(out, e.templates.Template, tplName, e.data, e.helperTemplates); err != nil {
				return err
			}
		} else {
